...
// For now we will assume that the sram cell is initialized to 0
// For a more robust design - we should check if the address has already been written to
// prior to using it as a base value for incrementing the accumulator.
// If it hasnt, then assume its 0 in the sum processs.
sram_cell #(
